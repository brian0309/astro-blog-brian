...
export default function SpeechBubble() {
  ...
  return (
    <div className="relative inline-block">
      ...
      >
        <div className="relative bg-white dark:bg-transparent text-gray-900 dark:text-white border-2 border-gray-200 dark:border-white px-2 py-1 sm:px-3 sm:py-1.5 md:px-4 md:py-2 lg:px-4 lg:py-2 xl:px-5 xl:py-2.5 rounded-md sm:rounded-lg shadow-lg min-w-max">
